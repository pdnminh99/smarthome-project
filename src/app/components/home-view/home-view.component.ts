...
export class HomeViewComponent implements OnInit {
  ...
  public get modulesMatchSearchInput(): Module[] {
    ...
    return this.modules.filter((value) => value.MAC.includes(this.searchInput) || value.name.includes(this.searchInput) || value.statusToString.includes(this.searchInput));
  }
